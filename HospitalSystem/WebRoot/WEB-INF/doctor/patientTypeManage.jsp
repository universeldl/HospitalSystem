                        ...
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <s:iterator value="#request.patientTypes" var="patientType">
                             <tbody>
	                                ...
	                                <td>
	                                	<button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#updateModal" onclick="updatePatientType(<s:property value="#patientType.patientTypeId"/>)">修改</button>
	                               	</td>                                              
                          	  </tbody>
                            </s:iterator>
                            </s:if>
