            ...
            <div class="panel panel-info">
                ...
                <form class="form-horizontal"
                    ...
                    <div class="form-group">
                        <div class="col-sm-2 control-label">问卷分类名称</div>
                        <div class="col-sm-10">
                            ...
                            <s:iterator value="#request.pb.beanList" var="surveyType">
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning btn-xs" data-toggle="modal"
                                            ...
                                            onclick="updateSurveyType(<s:property value="#surveyType.typeId"/>)">修改
                                    </button>
                                    <button type="button" class="btn btn-danger btn-xs"
                                            onclick="deleteSurveyType(<s:property value="#surveyType.typeId"/>)">删除
                                    </button>
                    ...
                    <s:if test="#request.pb!=null">
                        ...
                        <div class="pull-right"><!--右对齐--->
                            <ul class="pagination">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/doctor/surveyTypeManageAction_${pb.url }pageCode=1">首页</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/doctor/surveyTypeManageAction_${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a>
                                </li><!-- 上一页 -->
                                    <%-- 循环显示页码列表 --%>
                                <c:forEach begin="${begin }" end="${end }" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/doctor/surveyTypeManageAction_${pb.url }pageCode=${i}">${i}</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                ...
                                <c:if test="${pb.pageCode < pb.totalPage }">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/doctor/surveyTypeManageAction_${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a>
                                    </li>
                                </c:if>
                                    <%--否则显示尾页 --%>
                                <li>
                                    <a href="${pageContext.request.contextPath}/doctor/surveyTypeManageAction_${pb.url }pageCode=${pb.totalPage}">尾页</a>
                                </li>
                            </ul>
                        </div>
                    </s:if>
