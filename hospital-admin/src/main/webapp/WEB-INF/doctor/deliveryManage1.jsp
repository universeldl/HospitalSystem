                            ...
                            <form class="form-horizontal">
                                <div class="row">
                                    <div class="col-lg-5 form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" id="deliveryPatientOpenID"
                                                   name="deliveryPatientOpenID" type="text" value=""
                                    ...
                                    <div class="col-lg-5 form-group">
                                        <label class="col-lg-4 control-label" for="delivery_bno"><label
                                                class="text-danger">*&nbsp;</label>病人密码</label>
                                        <div class="col-lg-8">
                                            <input class="form-control" id="pwd" name="pwd" type="password" value=""
                                                   placeholder="请病人输入密码">
                                            <label class="control-label" for="delivery_bno"
                                                   style="display: none"></label>
                                        </div>
                                    </div>
                            ...
                            <s:iterator value="#request.pb.beanList" var="delivery">
                                ...
                                <td>
                                    <button type="button" class="btn btn-info btn-xs" data-toggle="modal"
                                            ...
                                            onclick="getDeliveryInfoById(<s:property value="#delivery.deliveryId"/>)">查看
                                    </button>
