                    ...
                    <div class="panel panel-default bootstrap-doctor-no-table-panel">
                        ...
                        <div class="bootstrap-doctor-no-table-panel-content bootstrap-doctor-panel-content collapse in">
                            <form class="form-horizontal"
                                  action="${pageContext.request.contextPath}/surveyAction_querySurvey.action"
                                  method="post">
                                ...
                                <div class="col-lg-5 form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id="surveyName" name="surveyName" type="text"
                                               value="">
                    ...
                    <s:if test="#request.pb!=null">
                        ...
                        <div class="pull-right"><!--右对齐--->
                            <ul class="pagination">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/surveyAction_${pb.url }pageCode=1">首页</a>
                                </li>
                                <li>
                                    <a href="${pageContext.request.contextPath}/surveyAction_${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a>
                                </li><!-- 上一页 -->
                                    <%-- 循环显示页码列表 --%>
                                <c:forEach begin="${begin }" end="${end }" var="i">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <li>
                                                <a href="${pageContext.request.contextPath}/surveyAction_${pb.url }pageCode=${i}">${i}</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                                ...
                                <c:if test="${pb.pageCode < pb.totalPage }">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/surveyAction_${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a>
                                    </li>
                                </c:if>
                                    <%--否则显示尾页 --%>
                                <li>
                                    <a href="${pageContext.request.contextPath}/surveyAction_${pb.url }pageCode=${pb.totalPage}">尾页</a>
                                </li>
                            </ul>
                        </div>
                    </s:if>
